<?php
    require_once '../../modelo/modelo_actualizar_paciente.php';
    $MPA = new Modelo_Paciente_ContaYApo_Actualizar();
    $ls_paciente_id = strtoupper(htmlspecialchars($_POST['ls_paciente_id'],ENT_QUOTES, 'UTF-8'));
    ...
    $consulta = $MPA->mandarDatos($ls_paciente_id,$ls_dni,$ls_nombre,$ls_apepaterno,$ls_apematerno,$ls_sexo,$ls_edad,$ls_tipo_edad,
