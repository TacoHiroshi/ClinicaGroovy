<?php
    ...
    $MPC = new Modelo_Paciente_Contacto_Actualizar();
    ...
    $consulta = $MPC->mandarDatos($ls_paciente_id,$ls_dni,$ls_nombre,$ls_apepaterno,$ls_apematerno,$ls_sexo,$ls_edad,$ls_tipo_edad,
