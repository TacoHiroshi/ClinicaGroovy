<?php
    ...
    class Modelo_Paciente_Min extends conexionBD{
        ...
        $ls_requiere_apoderado,$ls_ubigeo,$ls_paciente_contacto){
            ...
            $sql ="CALL SP_REGISTRAR_PACIENTE_MIN(?,?,?,?,?,?,?,?,?,?)";
            $query = $c->prepare($sql);
            $query->bindParam(1,$ls_dni);
            $query->bindParam(2,$ls_nombre);
            $query->bindParam(3,$ls_apepaterno);
            ...
            $query->bindParam(7,$ls_tipo_edad);
            $query->bindParam(8,$ls_requiere_apoderado);
            $query->bindParam(9,$ls_ubigeo);
            $query->bindParam(10,$ls_paciente_contacto);
            // $query->bindParam(15,$ls_examen_id);
            // $query->bindParam(16,$ls_resultadosarray);
            $resultado = $query->execute();
    ...
    class Modelo_Paciente_Contacto extends conexionBD{
        ...
        $ls_requiere_apoderado,$ls_ubigeo,$ls_paciente_contacto,$ls_email,$ls_celular){
            ...
            $sql ="CALL SP_REGISTRAR_PACIENTE_CONTACTO(?,?,?,?,?,?,?,?,?,?,?,?)";
            $query = $c->prepare($sql);
            $query->bindParam(1,$ls_dni);
            $query->bindParam(2,$ls_nombre);
            $query->bindParam(3,$ls_apepaterno);
            ...
            $query->bindParam(9,$ls_ubigeo);
            $query->bindParam(10,$ls_paciente_contacto);
            $query->bindParam(11,$ls_email);
            $query->bindParam(12,$ls_celular);
            // $query->bindParam(15,$ls_examen_id);
            // $query->bindParam(16,$ls_resultadosarray);
            $resultado = $query->execute();
    ...
    class Modelo_Paciente_Apoderado extends conexionBD{
        ...
        $ls_requiere_apoderado,$ls_nombre_apoderado,$ls_dni_apoderado,$ls_ubigeo,$ls_paciente_contacto){
            ...
            $sql ="CALL SP_REGISTRAR_PACIENTE_APODERADO(?,?,?,?,?,?,?,?,?,?,?,?)";
            $query = $c->prepare($sql);
            $query->bindParam(1,$ls_dni);
            $query->bindParam(2,$ls_nombre);
            $query->bindParam(3,$ls_apepaterno);
    ...
    class Modelo_Paciente_ContaYApo extends conexionBD{
        ...
        $ls_requiere_apoderado,$ls_nombre_apoderado,$ls_dni_apoderado,$ls_ubigeo,$ls_paciente_contacto,$ls_email,$ls_celular){
            ...
            $sql ="CALL SP_REGISTRAR_PACIENTE_CONTAYAPO(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $query = $c->prepare($sql);
            $query->bindParam(1,$ls_dni);
            $query->bindParam(2,$ls_nombre);
            $query->bindParam(3,$ls_apepaterno);
